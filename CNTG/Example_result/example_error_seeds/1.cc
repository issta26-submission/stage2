Error Type : assertion_error Program : // Header
#include <cassert>
#include <cstddef>
...
int test_api_sequence() {
  ...
  assert(memcmp(out_memory, "\x89PNG\r\n\x1a\n", 8) == 0);
...
Error Message : a : 1.cc : 66 : int test_api_sequence()
    : Assertion `memcmp(out_memory, "\x89PNG\r\n\x1a\n", 8) == 0' failed.
